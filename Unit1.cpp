...
{
	ShowMessage("Данный проект по машинной графике выполнен для 12 лаборатоной работы студентом группы 12001801 Цветковым Кириллом Сергеевичем");
}
//---------------------------------------------------------------------------

void __fastcall TForm1::About1Click(TObject *Sender)
{
	ShowMessage("Это проект, который реализует стандартную игру в понг, движение обьектов просчитывается отдельно, платформу можно двигать с помощью мыши, если игрок проигрывает на экран выводится количество набранных очков");
}
//---------------------------------------------------------------------------
